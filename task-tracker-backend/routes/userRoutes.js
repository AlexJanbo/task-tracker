...
const { loginUser, registerUser, updateUser, changePassword, changeProfilePicture, getAllUsers, changeRole, getUserInformation } = require('../controllers/userController')
